...
class TestChecksum:
    def test_normal(self):
        ...
        assert (
            qrcode.checksum(
                "00020101021129370016A000000677010111011300668999999995802TH53037646304"
            )
            == "FE29"
        )
